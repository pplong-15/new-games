...
ok("near1-sms", String(st.sms).indexOf("blank") !== -1);
...
ok("copy-A-flags", copyA.indexOf("same person") !== -1 || copyA.indexOf("Thirty-six") !== -1);
ok("copy-A-no-unlock", copyA.indexOf("Approve") === -1);
...
ok("copy-B-timeout", copyB.indexOf("Cutoff") !== -1);

ok("no-approve-keys", !D.NAMES.some((n) => /Approve|Deliverance|Release/.test(n.label)));
