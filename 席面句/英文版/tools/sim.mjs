...
ok("player-tong", D.PLAYER === "Tong Wanhe");
ok("no-pei", D.PLAYER.indexOf("Pei Wan") === -1);
...
ok("incomplete-msg", E.state.lastMessage.indexOf("Incomplete") !== -1);
...
ok("near-msg", E.state.lastMessage === "The whole sentence does not match.");
...
ok("locked-msg", E.state.lastMessage.indexOf("bag") !== -1);
...
ok("approve-msg", E.state.lastMessage.indexOf("Cannot approve") !== -1);
...
const ban = ["main quest", "level", "walkthrough", "unlock", "clue", "ending", "source code", "this game", "hidden page", "unique solution", "progress bar", "Pei Wan"];
