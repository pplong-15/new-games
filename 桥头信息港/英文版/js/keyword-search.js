(function (global) {
  ...
  function renderResults(mount, table) {
    ...
    if (hit && hit.forbidden) {
      ...
      box.innerHTML =
        "<h2>This file is no longer accessible</h2><p><span class=\"hidden-ink\">" +
    ...
    if (!hit) {
      box.innerHTML =
        "<h2>Search results</h2><p class=\"miss\">Sorry, no results matching \"" +
    ...
    box.innerHTML =
      ...
      hrefs.length +
      " result(s) matching this query:</p>" +
      links;
  }
