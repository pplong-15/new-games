...
try {
  ...
  ok("title-who", t.indexOf("Shen Wanzha") !== -1);
  ok("title-task", t.indexOf("Keys") !== -1 && t.indexOf("valid shift") !== -1);
  ok("title-lock", t.indexOf("Tonight") !== -1 && t.indexOf("omen") !== -1);
  ok("title-no-banned",
  ...
  ok("title-doc-img", t.indexOf("Clock in") !== -1);

  await click("#btn-enter");
  t = await text(page);
  ok("boot-who", t.indexOf("Shen Wanzha") !== -1 && t.indexOf("door") !== -1);
  ok("boot-person", t.indexOf("Wu Chengshan") !== -1);
  ok("boot-job", t.indexOf("keys") !== -1 || t.indexOf("valid shift") !== -1);
  ok("boot-doc", t.indexOf("Check the process page") !== -1 && t.indexOf("Check the gift ledger") !== -1);
  ok("boot-dims", t.indexOf("Pay cells") !== -1 && t.indexOf("Mind") !== -1 && t.indexOf("Hall name") !== -1 && t.indexOf("Slit") !== -1);
